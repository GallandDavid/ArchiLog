...
public class PopUpMenuAwt extends PopUpMenu{
    ...
    public PopUpMenuAwt(Point2D pos, int selected, boolean grouped) {
        super(new Point2D.Double(pos.getX() + _size.getX() / 2, pos.getY() + _size.getY() / 2), selected, grouped,
            new MenuAwt("Edit", new Point2D.Double(pos.getX() + _size.getX() / 2, pos.getY() + _size.getY() / 2 - (_size.getY() / 3)), new Point2D.Double(_size.getX(), _size.getY() / 3), grouped),
            new MenuAwt("Group", new Point2D.Double(pos.getX() + _size.getX() / 2, pos.getY() + _size.getY() / 2), new Point2D.Double(_size.getX(), _size.getY() / 3), grouped),
            new MenuAwt("Un-Group", new Point2D.Double(pos.getX() + _size.getX() / 2, pos.getY() + _size.getY() / 2 + (_size.getY() / 3)), new Point2D.Double(_size.getX(), _size.getY() / 3), grouped)
            );
    }
